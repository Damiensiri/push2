...
-- Migration totale : les comptes sont créés depuis le Backstage production.
...
CREATE TABLE IF NOT EXISTS paddock_card_product (
  ...
  price_cents INTEGER NOT NULL, units INTEGER NOT NULL, active INTEGER NOT NULL DEFAULT 1, updated_at TEXT NOT NULL
);
